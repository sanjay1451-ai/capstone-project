          ...
          <div className="modal-grid">
            ...
            <div className="modal-details">
              ...
              <div className="specs-table">
                ...
                <div className="spec-row">
                  <span className="spec-label">Posted Date:</span>
                  <span className="spec-value">
              ...
              {/* Action Buttons: Buy Now, Add to Favorites, Contact Seller, Request Exchange */}
              <div className="detail-actions-grid">
                <button 
                  className="btn btn-primary buy-btn"
                  onClick={handleBuyClick}
                  disabled={status === 'SOLD' || status === 'EXCHANGED'}
                >
                  <ShoppingBag size={18} />
                  <span>Buy Now</span>
                </button>
                ...
                <button
                  className={`btn btn-secondary fav-action-btn ${isFav ? 'active-fav' : ''}`}
                  onClick={handleToggleFavorite}
                >
                  <Heart size={17} fill={isFav ? '#ef4444' : 'none'} color={isFav ? '#ef4444' : 'currentColor'} />
                  <span>{isFav ? 'Saved' : 'Add to Wishlist'}</span>
                </button>
              </div>
